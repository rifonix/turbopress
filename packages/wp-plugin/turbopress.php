...
require_once TURBOPRESS_PATH . 'includes/transformer/class-plugin-assets.php';
...
require_once TURBOPRESS_PATH . 'includes/transformer/class-gravatar-localizer.php';
require_once TURBOPRESS_PATH . 'includes/optimizer/class-bloat-remover.php';
...
require_once TURBOPRESS_PATH . 'includes/cache/class-auto-purge.php';
